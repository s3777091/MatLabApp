function [theta1, theta2, theta3, fl] = IKinem(X, Y, Z, r, R, l, L)
    x0 = X;
    y0 = Y;
    z0 = Z;
    theta1 = IKinemTh(x0, y0, z0, r, R, l, L);
    %.......................................................
    x0 = X*cos(2*pi/3) + Y*sin(2*pi/3);
    y0 = Y*cos(2*pi/3) - X*sin(2*pi/3);
    z0 = Z;
    theta2 = IKinemTh(x0, y0, z0, r, R, l, L);
    %.......................................................
    x0 = X*cos(2*pi/3) - Y*sin(2*pi/3);
    y0 = Y*cos(2*pi/3) + X*sin(2*pi/3);
    z0 = Z;
    theta3 = IKinemTh(x0, y0, z0, r, R, l, L);
    %.......................................................
    if all(~isnan(theta1)) && all(~isnan(theta2)) && all(~isnan(theta3))
        fl = 0;
    else
        fl = -1; % non-existing
    end
